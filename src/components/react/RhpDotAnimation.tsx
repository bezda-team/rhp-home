...
const App = () => {
  ...
  return (
    <PlotContext.Provider value={{ plotData: plotData, dataMax: dataMax, orientation: orientation, theme: theme, vars: vars}}>
        <div id='plot' className='plot' style={{margin: "auto",width: "100%", minWidth: "660px", maxWidth: "1260px", display: "grid", justifyContent: "center", overflow: "hidden"}} onMouseEnter={stopAnimation} onMouseLeave={newInterval}>
        <SegmentPlot
            id='bar_plot_1'
            width='2442px'
            height='540px'
